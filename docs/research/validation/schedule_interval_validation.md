...
The committed 37-case fixture is derived from pinned IANA TZDB 2026c source
data, the release's `zic` and `zdump` tools, and plain UTC datetime arithmetic.
...
The normal benchmark is offline and records fixture/manifest integrity,
benchmark-input provenance, Python/tzdata versions, TZif hashes, and execution
provenance. The final grid endpoint is a display/evaluation sentinel, while
occupancy remains half-open.
