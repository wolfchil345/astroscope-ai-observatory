...
WEATHER_TRANSLATIONS: Final[dict[str, dict[str, str]]] = {
    ...
    "weather_start_date": {
        "en": "Weather-window start date",
        "ja": "天気確認の開始日",
        "ko": "날씨 확인 시작일",
        "th": "วันที่เริ่มช่วงสภาพอากาศ",
    },
    "weather_end_date": {
        "en": "Weather-window end date",
        "ja": "天気確認の終了日",
        "ko": "날씨 확인 종료일",
        "th": "วันที่สิ้นสุดช่วงสภาพอากาศ",
    },
    "weather_ambiguous_start": {
        "en": "The weather-window start occurs twice; select its occurrence.",
        "ja": "天気確認の開始時刻は2回発生します。どちらかを選択してください。",
        "ko": "날씨 창 시작 시간이 두 번 발생합니다. 발생 시점을 선택하세요.",
        "th": "เวลาเริ่มช่วงสภาพอากาศเกิดขึ้นสองครั้ง โปรดเลือกครั้งที่ต้องการ",
    },
    "weather_ambiguous_end": {
        "en": "The weather-window end occurs twice; select its occurrence.",
        "ja": "天気確認の終了時刻は2回発生します。どちらかを選択してください。",
        "ko": "날씨 창 종료 시간이 두 번 발생합니다. 발생 시점을 선택하세요.",
        "th": "เวลาสิ้นสุดช่วงสภาพอากาศเกิดขึ้นสองครั้ง โปรดเลือกครั้งที่ต้องการ",
    },
    "weather_fold_selection_start": {
        "en": "Select weather-window start occurrence",
        "ja": "天気確認の開始時刻を選択",
        "ko": "날씨 창 시작 발생 시점 선택",
        "th": "เลือกครั้งของเวลาเริ่มช่วงสภาพอากาศ",
    },
    "weather_fold_selection_end": {
        "en": "Select weather-window end occurrence",
        "ja": "天気確認の終了時刻を選択",
        "ko": "날씨 창 종료 발생 시점 선택",
        "th": "เลือกครั้งของเวลาสิ้นสุดช่วงสภาพอากาศ",
    },
    ...
    "weather_nonexistent_start": {
        "en": "The weather-window start is a nonexistent local time.",
        "ja": "天気確認の開始時刻は存在しない現地時刻です。",
        "ko": "날씨 창 시작 시간이 존재하지 않는 현지 시간입니다.",
        "th": "เวลาเริ่มช่วงสภาพอากาศเป็นเวลาท้องถิ่นที่ไม่มีอยู่จริง",
    },
    "weather_nonexistent_end": {
        "en": "The weather-window end is a nonexistent local time.",
        "ja": "天気確認の終了時刻は存在しない現地時刻です。",
        "ko": "날씨 창 종료 시간이 존재하지 않는 현지 시간입니다.",
        "th": "เวลาสิ้นสุดช่วงสภาพอากาศเป็นเวลาท้องถิ่นที่ไม่มีอยู่จริง",
    },
